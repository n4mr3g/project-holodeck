export default function About() {
  return (
    <div className="header-section">
      <h1>About</h1>
      <p>
        Project Holodeck is a web application that allows users to play
      ...
      <p>
        ...
        Generation. The holodeck is a virtual reality facility that allows users
        to interact with a simulated environment and its inhabitants.
      </p>
