export const cards = [
  {
    title: 'Fantasy',
    description: 'Play as the main protagonist in a fantasy world.',
    image:
  ...
  {
    title: 'Random',
    description: 'Be surprised! Play a random scenario.',
    image:
  ...
  {
    title: 'Cyberpunk',
    description: 'Play in a futuristic dystopian world.',
    image:
